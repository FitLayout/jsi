...
public class ReferenceCompareTest extends TestCase
{
	...
	{
		log.fine("testReferenceCompareAllFunctions()");
	...
	{
		log.fine("testReferenceCompareDelete()");
	...
	{
		log.fine("testReferenceCompareIntersect()");
	...
	{
		log.fine("testReferenceCompareNearest()");
	...
	{
		log.fine("testReferenceCompareNearestN()");
	...
	{
		log.fine("testReferenceCompareContains()");
